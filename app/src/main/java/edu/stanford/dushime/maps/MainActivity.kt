package edu.stanford.dushime.maps
...
import edu.stanford.dushime.maps.models.Place
import edu.stanford.dushime.maps.models.UserMap
import java.io.*
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.i(TAG, "this is a random log")
    ...
    private fun deserializeUserMaps(context: Context) : List<UserMap> {
        ...
        if (!dataFile.exists()) {
            Log.i(TAG, "Data file soes not exist yet")
            return emptyList()
        }
    ...
    private fun getDataFile(context: Context) : File {
        Log.i(TAG, "Getting gile direcrory ${context.filesDir}")
